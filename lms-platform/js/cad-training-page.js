// CAD training page functionality
        ...
        grid.innerHTML = courses.map(course => `
            <div class="course-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
                <div class="relative h-48 overflow-hidden">
                    <img src="https://img.icons8.com/color/48/autocad.png" alt="${course.title}" onerror="this.src='../assets/img/placeholder.svg'" class="course-image w-full h-full object-cover transition-transform duration-500 hover:scale-110">
                </div>
