document.addEventListener('DOMContentLoaded', () => {
    const grid = document.getElementById('construction-courses-grid');
    const courses = CourseService.getByCategory('Construction');
    ...
    if (grid) {
        if (courses.length > 0) {
            ...
            grid.innerHTML = '<p class="text-center col-span-3">No Construction courses available at the moment.</p>';
        }
    }
});
